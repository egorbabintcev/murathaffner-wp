                   ...
                   <div class="section_content">
                       <div class="tabs_wrap">
                           <div class="tabs">
                               ...
                               <a href="<?php echo get_home_url(); ?>/catalog/alyuminij/" class="tab current">Алюминий</a>
                               <a href="<?php echo get_home_url(); ?>/catalog/steklopakety/" class="tab">Стеклопакеты</a>
                               <div class="active" style="left: 188px;"></div>
                           </div>
                       </div>
                       <div class="content_wrap">
                           
                           <div class="tab_content" id="c-content2" style="display: block;">
                                <?php
